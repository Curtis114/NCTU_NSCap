...
def config(hosts, switches, routers, DHCPServer):
    ...
    DHCPServer.cmd('route add default gw 192.168.1.62')
    ...
    routers['r1'].cmd('route add -net 192.168.1.0/26 gw 192.168.1.62')
    routers['r1'].cmd('route add -net 192.168.1.64/26 gw 192.168.1.126')
    routers['r1'].cmd('route add default gw 10.0.1.1')
    routers['r2'].cmd('route add -net 10.0.0.0/16 gw 10.0.0.2')
    routers['r2'].cmd('route add -net 10.0.1.0/24 gw 10.0.1.2')
    routers['r2'].cmd('route add -net 192.168.1.0/24 gw 10.0.1.2')
    routers['r2'].cmd('route add -net 192.168.3.0/24 gw 10.0.0.2')
    routers['r3'].cmd('route add -net 10.0.0.0/16 gw 10.0.0.1')
    ...
    routers['r4'].cmd('route add -net 192.168.3.0/24 gw 192.168.3.254')
    routers['r4'].cmd('route add default gw 10.0.2.1')
